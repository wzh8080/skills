...
public class ImageHandler3 {
	public static void main(String[] args) {
		ImageHandler3 imageHandler = new ImageHandler3();
	...
	public static void grayImage() {
		...
		try {
			// read image
			BufferedImage img = ImageIO.read(new File("C:\\Users\\Administrator\\Desktop\\重塑结果.png"));
			...
			File out = new File("C:\\Users\\Administrator\\Desktop\\重塑结果2.png");
			if (!out.exists())
				out.createNewFile();
